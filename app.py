...
# Extensiones y directorios permitidos para archivos estáticos
...
def serve_static(filename):
    ...
    ext_allowed = any(filename.endswith(ext) for ext in ALLOWED_EXTENSIONS)
    if not ext_allowed and not dir_allowed:
